    ...
    for i in range(0, len(all_ids), BATCH):
        ...
        for company in companies:
            ...
            for service in services:
                ...
                same_signals = prev_exp.get("top_signals", []) == res.top_signals
                fields = {
                    ...
                    "explanation": {
                        ...
                        "summary": prev_exp.get("summary", "") if same_signals else "",
                        "summary_ai": bool(prev_exp.get("summary_ai")) if same_signals else False,
